...
namespace DataModel
{
	...
	public partial class NorthwindDB : LinqToDB.Data.DataConnection
	{
		...
		#region ProductsUnderThisUnitPrice

		[Sql.TableFunction(Schema="dbo", Name="ProductsUnderThisUnitPrice")]
		public ITable<Product> ProductsUnderThisUnitPrice(decimal? @price)
		{
			return this.GetTable<Product>(this, (MethodInfo)MethodBase.GetCurrentMethod(),
				@price);
		}
	...
	{
		[PrimaryKey, Identity   ] public int    ContactID    { get; set; } // int
		[Column,        Nullable] public string ContactType  { get; set; } // nvarchar(50)
	...
	{
		#region CustomersByCity

		public static IEnumerable<CustomersByCityResult> CustomersByCity(this DataConnection dataConnection, string @param1)
		{
			return dataConnection.QueryProc<CustomersByCityResult>("[dbo].[Customers By City]",
				new DataParameter("@param1", @param1, DataType.NVarChar));
		}
		...
		#region CustomersCountByRegion

		public static int CustomersCountByRegion(this DataConnection dataConnection, string @param1)
		{
			return dataConnection.ExecuteProc("[dbo].[Customers Count By Region]",
				new DataParameter("@param1", @param1, DataType.NVarChar));
		}
		...
		#region CustOrderTotal

		public static int CustOrderTotal(this DataConnection dataConnection, string @CustomerID, ref decimal? @TotalSales)
		{
			var ret = dataConnection.ExecuteProc("[dbo].[CustOrderTotal]",
				new DataParameter("@CustomerID", @CustomerID, DataType.NChar),
				new DataParameter("@TotalSales", @TotalSales, DataType.Money) { Direction = ParameterDirection.InputOutput });

			@TotalSales = Converter.ChangeTypeTo<decimal?>(((IDbDataParameter)dataConnection.Command.Parameters["@TotalSales"]).Value);
		...
		#region GetCustomerAndOrders

		public static IEnumerable<Customer> GetCustomerAndOrders(this DataConnection dataConnection, string @CustomerID)
		{
			return dataConnection.QueryProc<Customer>("[dbo].[Get Customer And Orders]",
				new DataParameter("@CustomerID", @CustomerID, DataType.NChar));
		}
		...
		#region WholeOrPartialCustomersSet

		public static IEnumerable<Customer> WholeOrPartialCustomersSet(this DataConnection dataConnection, int? @param1)
		{
			return dataConnection.QueryProc<Customer>("[dbo].[Whole Or Partial Customers Set]",
				new DataParameter("@param1", @param1, DataType.Int32));
		}
	...
	public static partial class SqlFunctions
	{
		...
		#region MinUnitPriceByCategory

		[Sql.Function(Name="dbo.MinUnitPriceByCategory", ServerSideOnly=true)]
		...
		#region TotalProductUnitPriceByCategory

		[Sql.Function(Name="dbo.TotalProductUnitPriceByCategory", ServerSideOnly=true)]
		public static decimal? TotalProductUnitPriceByCategory(int? @categoryID)
		{
			throw new InvalidOperationException();
		}
	...
	public static partial class TableExtensions
	{
		...
		public static Contact Find(this ITable<Contact> table, int ContactID)
		{
			return table.FirstOrDefault(t =>
